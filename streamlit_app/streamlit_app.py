...
st.title("Sentiment Sifters Data Uploader")
...
power_bi_url = "https://app.powerbi.com/view?r=eyJrIjoiZWZmNDQxMzMtZGI5Yi00YTA2LThmMjMtODIwMDIxNGMzYTljIiwidCI6ImY4NGExNjNjLWRhNWYtNGU3Ni1iNDdhLWFmNTRlZDY5NmI1ZSJ9"  # Replace with your Power BI Publish to Web link

st.markdown(f"""
    <iframe width="800" height="600" src="{power_bi_url}" frameborder="0" allowFullScreen="true"></iframe>
